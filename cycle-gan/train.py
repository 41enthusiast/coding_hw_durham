...
def main():
    ...
    dataset = HorseZebraDataset(
        root_horse=TRAIN_DIR+"/trainA", root_zebra=TRAIN_DIR+"/trainB", transform=transforms
    )
    val_dataset = HorseZebraDataset(
       root_horse=TRAIN_DIR+"/testA", root_zebra=TRAIN_DIR+"/testB", transform=transforms
    )
